...
(function() {
  ...
  Anchor = (function() {
    ...
    Anchor.prototype.realize = function() {
      var created, p, page, pagesTodo, promises, renderedPages, _k, _l, _len2, _ref1, _ref2, _ref3, _results,
        _this = this;
      ...
      try {
        ...
        for (_l = 0, _len2 = pagesTodo.length; _l < _len2; _l++) {
          ...
          p.fail(function(e) {
            return console.log("Error while trying to create highlight:", e.message, e.error.stack);
          });
        }
        return (_ref3 = Annotator.$).when.apply(_ref3, promises).always(function() {
          _this.fullyRealized = (renderedPages.length === _this.endPage - _this.startPage + 1) && (created.length === pagesTodo.length);
          if (created.length) {
